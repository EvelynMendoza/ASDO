 ...
 * @author Evelyn
 */
public class RegistroAgua extends javax.swing.JFrame {

    /**
     * Creates new form RegistroAgua
     */
    public RegistroAgua() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroAgua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroAgua().setVisible(true);
            }
        });
    }
